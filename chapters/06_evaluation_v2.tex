...
\subsection{RQ 3: How many Type Usages are necessary to accurately detect Anomalies?}
...
% something general?!
\todo[inline]{
What here? one stupid intro sentence? aka we use the android dataset for everything oä?
per RQ one part explaining the GENERAL idea}
...
keep it general?, no subsections / paragraphs
