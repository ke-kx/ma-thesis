...
evaluation to understand stuff
we answer: which variation performs best, what are some of the prerequisites that the technique has to perform good (input size, input quality)

and examine if using it for different purpose works at all or not?

To understand how well this approach works in general and which of the variants performs best, we apply the system to a dataset of more than 600 open source Android applications and manually analyze the results.
