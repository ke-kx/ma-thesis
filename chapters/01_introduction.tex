...
\todo{somehow assert how serious this is a bit better}
...
\todo[inline]{clearly formulate problem statement somewhere (3-5 sentences which describe the problem to be solved + the ansatz)}
...
rework after splitting dmmc chapter! + clearly state what is their work and what is mine
}
