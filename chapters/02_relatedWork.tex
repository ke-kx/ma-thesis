...
\todo[inline]{rework this!
    remove explanation of the technique and only explain the point: to find missing method calls
    the refer to the next chapter for explanation in depth
    + the results!
...
Here, the context is the name of the method in which the type usage occurs together with its signature (the types of the method parameters).
