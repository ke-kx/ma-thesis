...
\todo{generally in this section: think about the tense I wanna use, present / past and if it works well!}
...
too detailed?!
technique: static analysis of the code, then pattern based natural language processing. the resulting first-order logic formula is fed into an SMT solver to detect inconsistencies

--- continue in section 2 of paper
