...
\todo{here citation for codesmells are useful? (in fontana2016comparing or aDocotor i think)}
...
\todo[inline]{
some more info for those two?
Which other papers?! -> should be some which are NOT about findbugs 
    > present alterantives, maybe work in a slightly different manner, or just some sort of overview paper for static code smell detection oä!
}
...
\todo[inline]{Siggy:I don't really understand this. Especially how the contradictions look like and how they can be found.}
...
\todo{queries is not good to understand\ldots}
