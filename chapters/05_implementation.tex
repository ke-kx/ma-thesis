...
We analyze mostly Android applications, and the settings we use reflect this.
Figure~\ref{fig:sootparam} lists the settings we apply to configure it.
...
It iterates through all the statements in the body and marks those which invoke a method.
...
The \code{TYPE} reference specifies which type the type usage belongs to.
